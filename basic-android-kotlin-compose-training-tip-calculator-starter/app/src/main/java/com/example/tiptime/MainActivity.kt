                    ...
                    onValueChange: (String) -> Unit )
{
    ...
    TextField(
        ...
        value = value, //a text box that displays the string value you pass here
        leadingIcon = {Icon(painter = painterResource(id = leadingIcon),null)},
        onValueChange = onValueChange, // the lambda callback that's triggered when the user enters text in the text box.
        modifier = modifier,
        singleLine = true,
